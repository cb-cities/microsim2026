...
namespace Catch {
    ...
    struct FatalConditionHandler {
        ...
        static char altStackMem[32768];  // Fixed size for glibc 2.34+ compatibility
    ...
    char FatalConditionHandler::altStackMem[32768] = {};  // Fixed size for glibc 2.34+ compatibility
